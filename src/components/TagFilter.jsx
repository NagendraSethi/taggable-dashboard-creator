...
const TagItem = ({ tag, active, onClick }) => {
  return (
    <button
...
const TagSelector = () => {
  const { tags, activeTagIds, toggleTag: toggleTagFilter, resetTagSelection: clearTagFilters } = useDashboard();
  ...
  return (
    <div className="space-y-2 bg-white p-4 rounded-md shadow-sm border border-border">
        ...
        <div className="flex items-center space-x-3">
          <div className="flex items-center space-x-1 shrink-0">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="start" className="w-64 bg-background z-50 dropdown-menu-content">
                {surveyTags.length > 0 && (
                  <>
